  ...
  return (
    <label className={classNames('relative', className)}>
      ...
      <input
        ref={searchInputRef}
        type="text"
        className="border-input focus:border-primary disabled:border-inputfield-disabled placeholder:text-inputfield-placeholder bg-secondary block w-full appearance-none rounded-md border py-2 px-9 text-base leading-tight shadow transition duration-300 focus:outline-none"
